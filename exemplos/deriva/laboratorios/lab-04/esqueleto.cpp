// LAB-04 · esqueleto · prepara a Aula 7
...
class leitura {
 public:
  ...
  leitura(const leitura& o)
    ...
    // TODO 2: o destrutor decrementa `vivos`. A copia tambem e um nascimento -
    // o que falta aqui? Rode sem consertar e veja `vivos` fechar NEGATIVO.
  }
  ...
  [[nodiscard]] int intensidade() noexcept { return intensidade_; }  // TODO 4: falta const
  ...
  void ajustar(int nova) { intensidade_ = nova; }  // TODO 3: e a invariante?
 ...
 private:
  [[nodiscard]] static int validar(int v) {
    if (v < 0 || v > 100) {
      // TODO 1: recuse o valor invalido. Onde a invariante e estabelecida?
    }
    return v;
  }
  std::string sensor_;
