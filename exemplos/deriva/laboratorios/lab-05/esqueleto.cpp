// LAB-05 · esqueleto · prepara a Aula 8
...
class modo_bruto {
 public:
  ...
  ~modo_bruto() {
    // TODO 1: uma linha. Ela e a diferenca entre RAII e promessa. Rode sem
    // ela e veja o roteiro 3 falhar - o modo do sistema nunca volta.
...
class marca {
 public:
  ...
  // TODO 2: esta classe guarda recurso? E copiavel? Declare o que falta, e
  // escreva por que - a resposta nao e a mesma para `marca` e `modo_bruto`.
