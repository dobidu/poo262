// LAB-10 · solução de referência · prepara a Aula 19
...
class contador_de_instancias {
 ...
 protected:
  ...
  contador_de_instancias(const contador_de_instancias&) noexcept { ++vivos; ++criados; }
...
struct sonda : contador_de_instancias<sonda> { int energia = 100; };
struct drone : contador_de_instancias<drone> { int carga = 0; };
struct item : contador_de_instancias<item> { std::string nome = "sucata"; };
