// LAB-06 · esqueleto · prepara a Aula 11
...
struct base_quebrada {
  // TODO 1: uma palavra. Rode antes de acrescenta-la: o portao falha, e a
  // mensagem diz quantos objetos ficaram vivos. Depois acrescente e compare.
  ~base_quebrada() = default;
  virtual char glifo() const = 0;
};

struct derivada final : base_quebrada {
  // TODO 2: o contador esta no lugar certo? Tente move-lo para
  // `base_quebrada` e rode de novo COM o defeito do TODO 1 presente. O que
  // acontece, e por que isso e pior que nao ter contador?
