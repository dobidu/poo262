// LAB-07 · esqueleto · prepara a Aula 13
...
struct no {
  ...
  std::string nome_;
  // TODO 1: escolha o tipo de cada um por REQUISITO, e escreva o requisito.
  // Um possui e um observa - qual e qual, e por que essa e a unica combinacao
  // que nao vaza?
  std::vector<std::shared_ptr<no>> adiante_;
  std::shared_ptr<no> volta_;
};

/// Requisito 1: um dono, e o tempo de vida é o do dono. `unique_ptr`.
struct inventario {
  // TODO 2: um dono, e o tempo de vida e o do dono. Qual ponteiro?
  std::vector<std::shared_ptr<no>> pecas;
};
