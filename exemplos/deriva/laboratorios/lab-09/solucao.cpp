// LAB-09 · solução de referência · prepara a Aula 16
...
int main() {
  ...
  const unsigned sementes[] = {1u, 7u, 42u, 1000u, 65535u};
  ...
  checar("o roteiro exercita a borda esquerda", percurso_antes(3u, 60, 3) == percurso_depois(3u, 60, 3));
  checar("e a largura minima", percurso_antes(3u, 20, 1) == percurso_depois(3u, 20, 1));
